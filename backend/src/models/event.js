...
const eventSchema = new mongoose.Schema({
    ...
    category: { // Dành cho Tình nguyện viên lọc sự kiện
        type: String,
        required: true
    ...
    status: { // Dành cho Admin duyệt và quản lý vòng đời sự kiện
        type: String,
        enum: ['pending', 'approved', 'rejected', 'completed'],
        default: 'pending',
    },
    createdBy: { // Dành cho Event Manager, để biết ai tạo sự kiện
